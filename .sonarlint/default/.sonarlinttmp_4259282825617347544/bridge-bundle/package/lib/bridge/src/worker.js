...
const { analyzeJSTS, clearTypeScriptESLintParserCaches, createAndSaveProgram, createProgramOptions, deleteProgram, initializeLinter, writeTSConfigFile, searchPackageJsonFiles, } = require('@sonar/jsts');
